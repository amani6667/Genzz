    ...
    <Header 
      ...
      <div className="flex w-full">
        ...
        <div className="ml-0 md:ml-[330px] flex-1 p-6 md:p-10 overflow-y-auto w-full">
            ...
            <h1 className="text-5xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-500">
               যোগাযোগ
            </h1>
            <ul className='mt-[40px] '>
                <li className='text-[22px] mb-[8px]  text-cyan-500'>Security department : <span className='text-white ml-[10px]'>security@genzz.casino</span></li>
                <li className='text-[22px] mb-[8px]  text-cyan-500'>Partnership queries : <span className='text-white ml-[10px]'>partner@genzz.casino</span></li>
                <li className='text-[22px] mb-[8px]  text-cyan-500'>Become an agent : <span className='text-white ml-[10px]'>agent@genzz.casino</span></li>
                <li className='text-[22px] mb-[8px]  text-cyan-500'>General queries : <span className='text-white ml-[10px]'>support@genzz.casino</span></li>
            </ul>
        </div>
      </div>
    </section>
