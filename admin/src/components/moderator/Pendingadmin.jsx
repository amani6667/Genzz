        ...
        <tbody>
          {filterusers.map((user, index) => (
            <tr key={index} className="border-b even:bg-gray-50">
              ...
              <td>
              <button className="flex items-center border-[1px] border-red-500 px-[10px] py-[4px] rounded-[5px] text-red-500 hover:text-red-600">
                  <RiComputerLine className="mr-1" /> Delete
                </button>
              </td>
