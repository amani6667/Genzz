...
const overviewData = [
	...
	{ name: "Deposits", value: "9,876", change: -3.2, icon: ShoppingBag },
	{ name: "Total Withdraw", value: "1,234,567", change: 15.7, icon: Eye },
];

const OverviewCards = () => {
	return (
		<div className='grid grid-cols-1 gap-5 font-bai sm:grid-cols-2 lg:grid-cols-4 mb-8'>
