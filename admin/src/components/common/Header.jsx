...
const Header = ({ title, onMenuToggle }) => {
  ...
  return (
    <header className='bg-[#071251] font-bai sticky top-0 left-0 z-[10000] shadow-md border-b-[1px] border-gray-700 flex items-center justify-between px-4 py-[14px]'>
      ...
      <div className={`${showSearch ? 'flex' : 'hidden'} md:flex items-center bg-transparent border border-gray-500 rounded-md px-3 py-1 md:w-64 absolute md:static left-0 right-0 mx-4 md:mx-0 top-16 md:top-auto z-50 bg-[#071251]`}>
      ...
      <div className='flex items-center space-x-4'>
        ...
        <div className="relative">
          ...
          >
            ...
            <FiChevronDown className="ml-1 text-[#071251] hidden md:inline" />
          </div>
