...
export default function Unbanusermodel({ isOpen, onClose }) {
  ...
  const handleBanUser = async () => {
    ...
    setLoading(true);
    try {
      const response = await axios.put(`${base_url}/admin/unban-user/${id}`, {reason });
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg w-[90%] lg:w-[70%] xl:w-[30%]">
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-lg font-semibold text-orange-400">Unban User</h2>
        ...
        <div className="p-4">
          <p className="mb-4 text-[20px] text-gray-700">
            If you Unban this user, he/she will be able to access their dashboard.
          </p>
