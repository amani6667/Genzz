...
// -------------------logout-funtion---------------------
  ...
  return (
    <header className='w-full h-[9vh] bg-[#3366FF] fixed top-0 left-0 z-[1000] px-[20px] font-nunito py-[10px] flex justify-between items-center shadow-sm shadow-lg border-gray-200'>
     <Toaster/>
      {/* Left Side Logo + Menu */}
